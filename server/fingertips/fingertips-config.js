  ...
  upscale: process.env.UPSCALE_CRYSTAL === "1"
    ...
    : {
        ...
        inputSchema: {
          ...
          dynamic: { type: "number", required: false, default: 6, description: "HDR, try from 3 - 9" },
          creativity: { type: "number", required: false, default: 0.35, description: "Creativity, try from 0.3 - 0.9" },
          resemblance: { type: "number", required: false, default: 0.6, description: "Resemblance, try from 0.3 - 1.6" },
          num_inference_steps: { type: "integer", required: false, default: 18, description: "Number of denoising steps" },
          seed: { type: "integer", required: false, default: 1337, description: "Random seed for reproducibility" },
          output_format: { type: "string", required: false, default: "png", description: "Output format: webp, jpg, png" },
          sd_model: { type: "string", required: false, default: "juggernaut_reborn.safetensors [338b85bc4f]", description: "Stable Diffusion model checkpoint" },
          scheduler: { type: "string", required: false, default: "DPM++ 3M SDE Karras", description: "Scheduler for diffusion process" },
        },
      },
