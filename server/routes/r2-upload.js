// server/routes/r2-upload.js — R2 signed upload endpoints
"use strict";

import express from "express";
import { S3Client, PutObjectCommand } from "@aws-sdk/client-s3";
import { getSignedUrl } from "@aws-sdk/s3-request-presigner";
import { makeKey, publicUrlForKey, storeRemoteImageToR2, parseDataUrl, putBufferToR2 } from "../../r2.js";
import { safeString, normalizeIncomingPassId, setPassIdHeader } from "../helpers.js";
...
router.post("/api/r2/upload-signed", async (req, res) => {
  try {
...
router.post("/api/r2/store-remote-signed", async (req, res) => {
  try {
    const body = req.body || {};
...
router.post("/api/r2/upload-dataurl", async (req, res) => {
  try {
    const body = req.body || {};
