// server/mma/mma-db.js — Database operations for MMA generations
"use strict";
...
export async function finalizeGeneration({ supabase, generationId, url, prompt, vars, mode, matchasCharged }) {
  const updateFields = {
    mg_status: "done",
    mg_mma_status: "done",
    mg_output_url: url,
