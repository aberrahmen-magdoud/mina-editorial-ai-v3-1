...
async function getMmaCtxConfig(supabase) {
  const defaults = {
    ...
    still_one_shot: [
      ...
      "",
      "OVERIDE",
      'if user brief has madani in it overide and just give back the prompt as the user brief directly. If blur is part of the asthetic or grainy or film like or vignette yu just overide and dont put them in avoid section',
      "",
      "SAFETY:",
